...
type RealWorldClient interface {
	...
	GetArticles(ctx context.Context, in *GetArticlesRequest, opts ...grpc.CallOption) (*MultipleArticlesReplay, error)
	CreateArticles(ctx context.Context, in *CreateArticlesRequest, opts ...grpc.CallOption) (*SingleArticleReplay, error)
	UpdateArticles(ctx context.Context, in *UpdateArticlesRequest, opts ...grpc.CallOption) (*SingleArticleReplay, error)
	DeleteArticles(ctx context.Context, in *DeleteArticlesRequest, opts ...grpc.CallOption) (*SingleArticleReplay, error)
	AddComment(ctx context.Context, in *AddCommentRequest, opts ...grpc.CallOption) (*SingleCommentReplay, error)
	GetComment(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*MultipleCommentReplay, error)
	...
	GetTags(ctx context.Context, in *GetTagsRequest, opts ...grpc.CallOption) (*TagsReplay, error)
}
...
func (c *realWorldClient) GetArticles(ctx context.Context, in *GetArticlesRequest, opts ...grpc.CallOption) (*MultipleArticlesReplay, error) {
	out := new(MultipleArticlesReplay)
...
func (c *realWorldClient) CreateArticles(ctx context.Context, in *CreateArticlesRequest, opts ...grpc.CallOption) (*SingleArticleReplay, error) {
...
func (c *realWorldClient) UpdateArticles(ctx context.Context, in *UpdateArticlesRequest, opts ...grpc.CallOption) (*SingleArticleReplay, error) {
	out := new(SingleArticleReplay)
...
func (c *realWorldClient) DeleteArticles(ctx context.Context, in *DeleteArticlesRequest, opts ...grpc.CallOption) (*SingleArticleReplay, error) {
	out := new(SingleArticleReplay)
...
func (c *realWorldClient) GetComment(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*MultipleCommentReplay, error) {
	out := new(MultipleCommentReplay)
...
func (c *realWorldClient) GetTags(ctx context.Context, in *GetTagsRequest, opts ...grpc.CallOption) (*TagsReplay, error) {
	out := new(TagsReplay)
...
func (UnimplementedRealWorldServer) GetArticles(context.Context, *GetArticlesRequest) (*MultipleArticlesReplay, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetArticles not implemented")
}
func (UnimplementedRealWorldServer) CreateArticles(context.Context, *CreateArticlesRequest) (*SingleArticleReplay, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateArticles not implemented")
}
func (UnimplementedRealWorldServer) UpdateArticles(context.Context, *UpdateArticlesRequest) (*SingleArticleReplay, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateArticles not implemented")
}
func (UnimplementedRealWorldServer) DeleteArticles(context.Context, *DeleteArticlesRequest) (*SingleArticleReplay, error) {
...
func (UnimplementedRealWorldServer) GetComment(context.Context, *GetCommentRequest) (*MultipleCommentReplay, error) {
...
func (UnimplementedRealWorldServer) GetTags(context.Context, *GetTagsRequest) (*TagsReplay, error) {
